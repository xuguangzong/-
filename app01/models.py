...
class Course(models.Model):
    """专题课程 OR 学位课模块"""
    name = models.CharField(verbose_name='课程名称',max_length=128, unique=True) # Python基础
    course_img = models.CharField(max_length=255)

    sub_category = models.ForeignKey("CourseSubCategory",verbose_name='所属的子类') #

    course_type_choices = ((0, '付费'), (1, 'VIP专享'), (2, '学位课程'))
    course_type = models.SmallIntegerField(choices=course_type_choices)

    degree_course = models.ForeignKey("DegreeCourse", blank=True, null=True, help_text="若是学位课程，此处关联学位表",verbose_name='所属大类')
    ...
    class Meta:
        verbose_name_plural = "06.课程名称"
    def __str__(self):
        return self.name

class CourseDetail(models.Model):
    """课程详情页内容"""
    course = models.OneToOneField("Course",verbose_name='课程名称')
...
class Comment(models.Model):
    ...
    disagree_number = models.IntegerField(default=0, verbose_name="踩")
    disagree_number = models.IntegerField(default=0, verbose_name="赞同数")
    date = models.DateTimeField(auto_now_add=True)
