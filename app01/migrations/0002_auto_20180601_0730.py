# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-06-01 07:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='course',
            options={'verbose_name_plural': '06.课程名称'},
        ),
        migrations.AlterField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='若是学位课程，此处关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.DegreeCourse', verbose_name='所属大类'),
        ),
        migrations.AlterField(
            model_name='course',
            name='name',
        ...
        migrations.AlterField(
            model_name='course',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.CourseSubCategory', verbose_name='所属的子类'),
        ),
        migrations.AlterField(
            model_name='coursedetail',
            name='course',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.Course', verbose_name='课程名称'),
        ),
        migrations.AlterField(
            model_name='coursedetail',
            name='course_slogan',
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, related_name='recommend_by', to='app01.Course', verbose_name='推荐课程'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
